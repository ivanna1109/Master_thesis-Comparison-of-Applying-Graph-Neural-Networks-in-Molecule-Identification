...
with open('new_training/train_results/gSage_new/model_summary-moreActiveABCDE.txt', 'w') as f:
    model.summary(print_fn=lambda x: f.write(x + '\n'))
print("Zavrseno pisanje u fajl.")

print("Pisemo history treninga..")
history_df = pd.DataFrame(history.history)
history_df.to_csv('new_training/train_results/gSage_new/gSage_history_moreActiveABCDE.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights('new_training/train_results/gSage_new/gSage_model_moreActiveABCDE.h5')
