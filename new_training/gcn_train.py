...
#from models.gcnModel_v2 import GCN
import pandas as pd
...
with open('new_training/train_results/gcn_new/model_summary-gcn_moreActiveABCDE.txt', 'w') as f:
    model.summary(print_fn=lambda x: f.write(x + '\n'))
print("Zavrseno pisanje u fajl.")

print("Pisemo history treninga..")
history_df = pd.DataFrame(history.history)
history_df.to_csv('new_training/train_results/gcn_new/gcn_history_moreActiveABCDE.csv', index=False)

print("Cuvanje tezina modela..")
model.save_weights('new_training/train_results/gcn_new/gcn_model_moreActiveABCDE.h5')
